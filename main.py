...
# appending the values {1, 0} to another list depending on whether the csv files say the person is positive or negative for covid. For each F1, we train
# our model, then we clear both lists and move to the next F1 until done. Once finished, we save our model and test. We'll save folder 20200525 as our testing
# data set
